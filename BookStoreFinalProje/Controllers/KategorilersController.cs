...
namespace BookStoreFinalProje.Controllers
{
    public class KategorilersController : Controller
    {
        ...
        public KategorilersController(BookStoreDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Kategorilers != null ? 
                          ...
                          Problem("Entity set 'BookStoreDbContext.Kategorilers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookStoreDbContext.Kategorilers'  is null.");
            }
            var kategoriler = await _context.Kategorilers.FindAsync(id);
            if (kategoriler != null)
            {
